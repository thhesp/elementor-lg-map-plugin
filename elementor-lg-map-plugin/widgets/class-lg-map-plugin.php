...
class LgMapPlugin extends Widget_Base {
	...
	public function __construct( $data = array(), $args = null ) {
		...
		wp_register_style( 'lg-map-plugin-css', plugins_url( '/assets/css/lg-map-plugin.css', ELEMENTOR_MAP_PLUGIN ), array(), '1.8.0' );
	
	    wp_register_script( 'lg-map-plugin-js', plugins_url( '/assets/js/lg-map-plugin.js', ELEMENTOR_MAP_PLUGIN ), array(), '1.8.0' );
	    wp_register_script( 'lg-map-plugin-meetups-js', plugins_url( '/assets/js/lg-map-plugin-meetups.js', ELEMENTOR_MAP_PLUGIN ), array(), '1.8.0' );
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'overlay_text',
			array(
				'label' => esc_html__( 'Kartenoverlay text', 'elementor-lg-map-plugin' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				'default' => esc_html__( 'interagieren', 'elementor-lg-map-plugin' )
			)
		);
		$this->add_control(
			'load_meetup',
